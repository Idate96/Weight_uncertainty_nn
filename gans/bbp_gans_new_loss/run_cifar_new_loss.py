...
from gans.bbp_gans_new_loss.generator import Generator
from gans.bbp_gans_new_loss.discriminator import Discriminator
...
if __name__ == '__main__':
    generator = Generator(10**-3, [1024, 1024], label='bbp_cifar_new_loss_00')
