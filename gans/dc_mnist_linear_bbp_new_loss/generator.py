...
class Generator(nn.Module):
    ...
    def log_likelyhood(self, fake_scores):
        prob = 1 - fake_scores
        return prob
    ...
    def loss(self, scores_fake):
        ...
        log_pw, log_likelyhood, log_qw = 0, 0, 0
        ...
        #                                    self.W2_deconv_sigma).sum())
            ...
            log_likelyhood += 1/self.num_samples * self.log_likelyhood(scores_fake).sum()

        loss = 1/batch_size * (1/num_batches * (log_qw - log_pw) - log_likelyhood)
        return loss
