...
from gans.bbp_gans_new_loss_mnist.generator import Generator
from gans.bbp_gans_new_loss_mnist.discriminator import Discriminator
...
if __name__ == '__main__':
    ...
    generator = Generator(10**-3, [1024, 1024], label='bbp_mnist_new_loss_00')
    discriminator = Discriminator(10**-3, [1024, 1024], label='bbp_dc_cifar_00')
