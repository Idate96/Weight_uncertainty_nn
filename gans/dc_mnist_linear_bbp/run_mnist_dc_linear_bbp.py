...
from gans.dc_mnist_linear_bbp.generator import Generator
from gans.dc_mnist_linear_bbp.discriminator import Discriminator
    ...
    for epoch in range(num_epochs):
        for x, _ in loader_train:
            ...
            if (iter_count % show_every == 0):
                checkpt_t = time.time()
                # print("dis weights ", discriminator.weights.data.numpy())
                ...
                print("variance output generator : ", torch.std(fake_images).data)
...
if __name__ == '__main__':
    generator = Generator(10**-3, [1024, 1024], label='dc_mnist_linear_bbp_00')
    discriminator = Discriminator(10**-3, [1024, 1024], label='dc_mnist_linear_bbp_00')
